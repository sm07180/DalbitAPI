...
public class StringUtil {
     ...
     */
    public static String removeCommaChar(String str) throws NullPointerException{
        return remove(str, ',');
    }
     ...
     *  입력문자열이 null인 경우 출력문자열은 null
     */
    public static String removeMinusChar(String str) throws NullPointerException{
        return remove(str, '-');
    }
     ...
     */
    public static String replace(String source, String subject, String object) throws NullPointerException{
     ...
     */
    public static String replaceOnce(String source, String subject, String object) throws NullPointerException{
        StringBuffer rtnStr = new StringBuffer();
        String preStr = "";
        String nextStr = source;
     ...
     * @return sb.toString() 새로운 문자열로 변환된 문자열
     */
    public static String replaceChar(String source, String subject, String object) throws NullPointerException{
        StringBuffer rtnStr = new StringBuffer();
        String preStr = "";
        String nextStr = source;
        String srcStr = source;
     ...
     *</pre>
     */
    public static String nullConvert(Object src) throws NullPointerException{
     ...
     *</pre>
     */
    public static String nullConvert(String src) throws NullPointerException{
     ...
     *</pre>
     */
    public static int zeroConvert(Object src) throws NullPointerException{
     ...
     *</pre>
     */
    public static int zeroConvert(String src) throws NullPointerException{
     ...
     */
    public static String removeWhitespace(String str) throws NullPointerException{
        if (isEmpty(str)) {
            return str;
        }
        int sz = str.length();
     ...
     */
    public static String checkHtmlView(String strString) throws NullPointerException{
        String strNew = "";
     ...
     * @return " - "가 추가된 입력문자열
     */
    public static String addMinusChar(String date) throws NullPointerException{
        if (date.length() == 8)
    ...
    /**
     * <p>값을 지정한 format 형식으로 변환한다.</p>
     *
     * <pre>
     *   StringUtil.formatData("100000","#,###") = "100,000"
     * </pre>
     *
     * @param data 입력받는 문자열
     * @return 포멧 형식에 따른 데이타
     */
    public static String formatData(String data , String format){
        String price = "";
        if(data!=null && !"".equals(data)){
            DecimalFormat df = new DecimalFormat(format);
            price = df.format(Double.parseDouble(data));
        }
        return price;
    }
    ...
    public static String formatDate(String StringDate){
        ...
        if (!Pattern.matches(regEx, StringDate)) {
            return StringDate;
        }
        return StringDate.replaceAll(regEx, "$1.$2.$3");
    }
    ...
    public static String formatPhone(String StringPhone){
        ...
        if (!Pattern.matches(regEx, StringPhone)) {
            return StringPhone;
        }
