...
public enum ResMessage {
    ...
    C60002("60002", "팀을 삭제하면 72시간 이후에 생성할 수 있습니다."),
    C60003("60003", "이미 가입된 팀이 있는 사용자입니다."),
    C60004("60004", "레벨이 부족합니다."),
    C60005("60005", "이미 있는 팀 이름입니다."),
    ...
    C60015("60015", "이미 가입된 팀이 있는 사용자입니다."),
    C60016("60016", "신청 내역이 없습니다."),
    C60017("60017", "권한이 없습니다."),
    C60018("60018", "출석완료"),
    C60019("60019", "대표설정 배지수 초과 되었습니다."),
    C60020("60020", "수정시간 초과 되었습니다."),
    C60021("60021", "팀 미가입 상태입니다."),
    C60022("60022", "배지 조건 미달성 하였습니다."),
    C60023("60023", "다른 팀에 가입되어 팀을 만들 수 없습니다."),
