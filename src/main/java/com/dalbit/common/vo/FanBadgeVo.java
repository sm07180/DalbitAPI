...
public class FanBadgeVo implements Serializable {
    ...
    public FanBadgeVo(){
        if(!"real".equals(DalbitUtil.getActiceProfile())){
            ...
            if(rndNumber == 1) {
                this.text = "회장님";
                this.icon = "https://image.dalbitlive.com/badge/200617/fanbadge_01_1534.png";
                this.startColor = "#fe8fbe";
                this.endColor = "#f82cad";
            }else if(rndNumber == 2){
                this.text = "부회장님";
                this.icon = "https://image.dalbitlive.com/badge/200617/fanbadge_02_1534.png";
                this.startColor = "#7210ff";
                this.endColor = "#817dff";
            }else if(rndNumber == 3){
                this.text = "사장님";
                this.icon = "https://image.dalbitlive.com/badge/200617/fanbadge_03_1534.png";
