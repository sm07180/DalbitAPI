...
public class CommonController {
    ...
    public String tmpStore(HttpServletRequest request, HttpServletResponse response)
    {
        ...
        store1.put("priceNm", "");
        store1.put("img", "https://image.dalbitcast.com/store/store_1.png");
        ...
        store2.put("priceNm", "");
        store2.put("img", "https://image.dalbitcast.com/store/store_2.png");
        ...
        store3.put("priceNm", "");
        store3.put("img", "https://image.dalbitcast.com/store/store_3.png");
        ...
        store4.put("priceNm", "");
        store4.put("img", "https://image.dalbitcast.com/store/store_4.png");
        ...
        store5.put("priceNm", "");
        store5.put("img", "https://image.dalbitcast.com/store/store_5.png");
        ...
        store6.put("priceNm", "");
        store6.put("img", "https://image.dalbitcast.com/store/store_6.png");
