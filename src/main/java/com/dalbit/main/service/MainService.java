...
public class MainService {
    ...
    public Map<String, Object> getInnerServerList(HttpServletRequest request, String os){
        ...
        String realWebRtcSocketURI = "https://sv.dallalive.com:8000/socketcluster/";
        String devWebRtcSocketURI = "https://devsv1.dallalive.com:8000/socketcluster/";
        String devPhotoURI = "https://devphoto.dallalive.com/";
        String clientIP = ipUtil.getClientIP(request);
        result.put("innerChk", clientIP);

        if (ipUtil.validationInnerIP(clientIP)) {
            if (StringUtils.equals(os, "mob")) {//mobile
                list.add(new ServerListVO("실서버", "https://m.dallalive.com", "https://api.dallalive.com/", "https://photo.dallalive.com/", realWebRtcSocketURI));
                list.add(new ServerListVO("개발서버", "https://devm.dallalive.com", "https://devapi.dallalive.com/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("내부서버", "https://devm2.dallalive.com", "https://devapi2.dallalive.com/", "https://devphoto2.dallalive.com/", devWebRtcSocketURI));
                list.add(new ServerListVO("강알찬", "https://devm-aaasss86.dallalive.com", "https://devm-aaasss86.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("김한호", "https://devm-hhk2745.dallalive.com", "https://devm-hhk2745.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("김훈", "https://devm-ironynet.dallalive.com", "https://devm-ironynet.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("김현진", "https://devm-khj.dallalive.com", "https://devm-khj.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("김효빈", "https://devm-khb.dallalive.com", "https://devm-khb.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("문형진", "https://devm-moon.dallalive.com", "https://devapi.dallalive.com/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("박성민", "https://devm-parksm.dallalive.com", "https://devm-parksm.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("박용훈", "https://devm-parkyh.dallalive.com", "https://devm-parkyh.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("박지송", "https://devm-jisong0292.dallalive.com", "https://devapi.dallalive.com/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("박지호", "https://devm-ghost1565.dallalive.com", "https://devapi.dallalive.com/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("송영호", "https://devm-pogus55.dallalive.com", "https://devm-parkyh.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("이승재", "https://devm-nonp2.dallalive.com", "https://devm-nonp2.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("이정혁", "https://devm-jhlee.dallalive.com", "https://devm-jhlee.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));
                list.add(new ServerListVO("홍광표", "https://devm-gonetpower.dallalive.com", "https://devm-gonetpower.dallalive.com:463/", devPhotoURI, devWebRtcSocketURI));

                result.put("list", list);
                return result;
            } else if (StringUtils.equals(os, "web")) {// web
                list.add(new ServerListVO("실서버", "https://www.dallalive.com"));
                list.add(new ServerListVO("개발서버", "https://devwww.dallalive.com"));
                list.add(new ServerListVO("내부서버", "https://devwww2.dallalive.com"));
                list.add(new ServerListVO("강알찬", "https://devwww-aaasss86.dallalive.com"));
                list.add(new ServerListVO("김한호", "https://devwww-hhk2745.dallalive.com"));
                list.add(new ServerListVO("김훈", "https://devwww-ironynet.dallalive.com"));
                list.add(new ServerListVO("김현진", "https://devwww-khj.dallalive.com"));
                list.add(new ServerListVO("김효빈", "https://devwww-khb.dallalive.com"));
                list.add(new ServerListVO("문형진", "https://devwww-moon.dallalive.com"));
                list.add(new ServerListVO("박성민", "https://devwww-parksm.dallalive.com"));
                list.add(new ServerListVO("박용훈", "https://devwww-parkyh.dallalive.com"));
                list.add(new ServerListVO("박지송", "https://devwww-jisong0292.dallalive.com"));
                list.add(new ServerListVO("박지호", "https://devwww-ghost1565.dallalive.com"));
                list.add(new ServerListVO("송영호", "https://devwww-pogus55.dallalive.com"));
                list.add(new ServerListVO("이승재", "https://devwww-nonp2.dallalive.com"));
                list.add(new ServerListVO("이정혁", "https://devwww-jhlee.dallalive.com"));
                list.add(new ServerListVO("홍광표", "https://devwww-gonetpower.dallalive.com"));
