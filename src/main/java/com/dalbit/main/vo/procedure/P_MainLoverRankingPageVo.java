...
@Getter @Setter
public class P_MainLoverRankingPageVo extends P_ApiVo {

    public P_MainLoverRankingPageVo(){}
    public P_MainLoverRankingPageVo(MainRankingPageVo mainRankingPageVo, HttpServletRequest request){
