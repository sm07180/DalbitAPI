...
public class ClipService {
    ...
    public String clipAdd(P_ClipAddVo pClipAddVo, HttpServletRequest request) throws GlobalException {
        ...
        if(!ipUtil.isInnerIP(ipUtil.getClientIP(request))){
            ...
            if(!DalbitUtil.isEmpty(codeVo)){
                if(codeVo.getValue().equals("Y")){
                    return gsonUtil.toJson(new JsonOutputVo(EventStatus.설정_클립업로드_참여불가상태));
                }
            }
        }
        ...
        if(0 < adminBlockCnt){
            return gsonUtil.toJson(new JsonOutputVo(MemberStatus.차단_이용제한));
        }
        ...
        if(DalbitUtil.isStringMatchCheck(systemBanWord, pClipAddVo.getTitle())){
            return gsonUtil.toJson(new JsonOutputVo(CommonStatus.클립등록제목금지));
        }
        ...
        if(min + sec > 600){
            return gsonUtil.toJson(new JsonOutputVo(MypageStatus.클립재생시간_10분초과));
        }
        ...
        if(ClipStatus.클립등록_성공.getMessageCode().equals(procedureVo.getRet())) {
            ...
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립등록_성공, returnMap));
        }else if(ClipStatus.클립등록_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립등록_회원아님));
        }else if(ClipStatus.클립등록_20세제한.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립등록_20세제한));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립등록_실패));
        }
        return result;
    }
    ...
    public String clipEdit(P_ClipEditVo pClipEditVo, HttpServletRequest request) throws GlobalException {
        ...
        String result="";
        if(ClipStatus.클립수정_성공.getMessageCode().equals(procedureVo.getRet())) {
            if(isDone){
        ...
        }else if(ClipStatus.클립수정_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립수정_회원아님));
        }else if(ClipStatus.클립수정_클립없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립수정_클립없음));
        }else if(ClipStatus.클립수정_회원번호_클립회원번호아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립수정_회원번호_클립회원번호아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립수정_실패));
        }
        return result;
    }
    ...
    public String clipList(P_ClipListVo pClipListVo) {
        ...
        if(DalbitUtil.isEmpty(clipListVo)){
            ...
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립리스트_조회_없음, clipList));
        }
        ...
        if(Integer.parseInt(procedureOutputVo.getRet()) > 0) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립리스트_조회_성공, clipList));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립리스트_조회_실패));
        }
        return result;
    }
    ...
    public String clipPlay(P_ClipPlayVo pClipPlayVo, String state, HttpServletRequest request) {
        ...
        if(ClipStatus.클립플레이_성공.getMessageCode().equals(procedureVo.getRet())) {
            if("edit".equals(state)) {
                result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립수정_성공, returnMap));
            } else {
                result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립플레이_성공, returnMap));
            }
        }else if(ClipStatus.클립플레이_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립플레이_회원아님, returnMap));
        }else if(ClipStatus.클립플레이_클립번호없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립플레이_클립번호없음, returnMap));
        }else if(ClipStatus.클립플레이_팬아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립플레이_팬아님, returnMap));
        }else if(ClipStatus.클립플레이_20세미만.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립플레이_20세미만, returnMap));
        }else if(ClipStatus.클립플레이_차단회원재생불가.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립플레이_차단회원재생불가, returnMap));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립플레이_실패, returnMap));
        }
        return result;
    }
    ...
    public String clipPlayList(P_ClipPlayListVo pClipPlayListVo) {
        ...
        if(DalbitUtil.isEmpty(clipPlayListVo)){
            ...
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_재생목록_조회_없음, clipPlayList));
        }
        ...
        String result;
        if(Integer.parseInt(procedureOutputVo.getRet()) > 0) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_재생목록_조회_성공, clipPlayList));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_재생목록_조회_실패));
        }
        return result;
    }
    ...
    public String clipGift(P_ClipGiftVo pClipGiftVo) {
        ...
        String result="";
        if(ClipStatus.클립_선물하기_성공.getMessageCode().equals(procedureVo.getRet())) {
            HashMap resultMap = new Gson().fromJson(procedureVo.getExt(), HashMap.class);
            HashMap returnMap = new HashMap();
...
//            returnMap.put("repeatCnt", isDirect ? directItemCnt : (DalbitUtil.isEmpty(item.getSoundFileUrl()) ? pClipGiftVo.getItem_cnt() : pClipGiftVo.getItem_cnt() * 2));
            ...
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물하기_성공, returnMap));
        }else if(ClipStatus.클립_선물하기_요청회원_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물하기_요청회원_회원아님));
        }else if(ClipStatus.클립_선물하기_대상회원_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물하기_대상회원_회원아님));
        }else if(ClipStatus.클립_선물하기_클립번호없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물하기_클립번호없음));
        }else if(ClipStatus.클립_선물하기_클립번호_대상회원번호_불일치.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물하기_클립번호_대상회원번호_불일치));
        }else if(ClipStatus.클립_선물하기_본인불가.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물하기_본인불가));
        }else if(ClipStatus.클립_선물하기_아이템코드없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물하기_아이템코드없음));
        }else if(ClipStatus.클립_선물하기_달부족.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물하기_달부족));
            ...
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물하기_실패));
        }
    ...
    public String clipGood(P_ClipGoodVo pClipGoodVo) {
        ...
        if(ClipStatus.클립_좋아요_성공.getMessageCode().equals(procedureVo.getRet())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_좋아요_성공, returnMap));
        }else if(ClipStatus.클립_좋아요_요청회원_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_좋아요_요청회원_회원아님));
        }else if(ClipStatus.클립_좋아요_클립번호없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_좋아요_클립번호없음));
        }else if (ClipStatus.클립_좋아요_이미좋아요누름.getMessageCode().equals(procedureVo.getRet())) {
            returnMap.put("isGood", true);
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_좋아요_이미좋아요누름, returnMap));
        }else if(ClipStatus.클립_좋아요_차단회원.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_좋아요_차단회원));
        }else {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_좋아요_실패));
        }
    ...
    public String clipGiftRankTop3(P_ClipGiftRankTop3Vo pClipGiftRank3Vo) {
        ...
        if(DalbitUtil.isEmpty(clipGiftRankTop3VoList)){
            ...
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물랭킹_TOP3_조회_없음, clipGiftRankTop3List));
        }
        ...
        String result;
        if(Integer.parseInt(procedureOutputVo.getRet()) > 0) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물랭킹_TOP3_조회_성공, clipGiftRankTop3List));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물랭킹_TOP3_조회_실패));
        }
        return result;
    }
    ...
    public String clipRankList(P_ClipGiftRankListVo pClipGiftRankListVo, HttpServletRequest request) {
        ...
        if(DalbitUtil.isEmpty(clipGiftRankListVo)){
            ...
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물랭킹_조회_없음, clipGiftRankList));
        }
        ...
        if(Integer.parseInt(procedureVo.getRet()) > 0) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물랭킹_조회_성공, clipGiftRankList));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_선물랭킹_조회_실패));
        }
        return result;
    }
    ...
    public String clipGiftList(P_ClipGiftListVo pClipGiftListVo, HttpServletRequest request) {
        ...
        if(DalbitUtil.isEmpty(clipGiftListVo)){
            ...
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_받은선물내역_조회_없음, clipGiftList));
        }
        ...
        String result;
        if(Integer.parseInt(procedureOutputVo.getRet()) > 0) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_받은선물내역_조회_성공, clipGiftList));
        }else if(ClipStatus.클립_받은선물내역_조회_요청회원_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_받은선물내역_조회_요청회원_회원아님));
        }else if(ClipStatus.클립_받은선물내역_조회_클립없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_받은선물내역_조회_클립없음));
        }else if(ClipStatus.클립_받은선물내역_조회_요청회원번호_클립회원번호아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_받은선물내역_조회_요청회원번호_클립회원번호아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_받은선물내역_조회_실패));
        }
        return result;
    ...
    public String clipDelete(P_ClipDeleteVo pClipDeleteVo, HttpServletRequest request) {
        ...
        String result="";
        if(ClipStatus.클립삭제_성공.getMessageCode().equals(procedureVo.getRet())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립삭제_성공));
        }else if(ClipStatus.클립삭제_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립삭제_회원아님));
        }else if(ClipStatus.클립삭제_클립없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립삭제_클립없음));
        }else if(ClipStatus.클립삭제_회원번호_클립회원번호아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립삭제_회원번호_클립회원번호아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립삭제_실패));
        }
    ...
    public String clipReplyList(P_ClipReplyListVo pClipPlayListVo) {
        ...
        if(DalbitUtil.isEmpty(clipReplyListVo)){
            ...
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글목록_조회_없음, clipReplyList));
        }
        ...
        String result;
        if(Integer.parseInt(procedureOutputVo.getRet()) > 0) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글목록_조회_성공, clipReplyList));
        }else if(ClipStatus.클립_댓글목록_조회_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글목록_조회_회원아님));
        }else if(ClipStatus.클립_댓글목록_조회_클립없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글목록_조회_클립없음));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글목록_조회_실패));
        }
        return result;
    }
    ...
    public String clipReplyAdd(P_ClipReplyAddVo pClipReplyAddVo, HttpServletRequest request) {
        ...
        String result="";
        if(ClipStatus.클립_댓글등록_성공.getMessageCode().equals(procedureVo.getRet())) {
            HashMap clipReplyList = new HashMap();
            ...
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글등록_성공, clipReplyList));
        }else if(ClipStatus.클립_댓글등록_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글등록_회원아님));
        }else if(ClipStatus.클립_댓글등록_클립없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글등록_클립없음));
        }else if(ClipStatus.클립_댓글등록_차단회원.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글등록_차단회원));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글등록_실패));
        }
        return result;
    }
    ...
    public String clipReplyEdit(P_ClipReplyEditVo pClipReplyEditVo, HttpServletRequest request) {
        ...
        String result="";
        if(ClipStatus.클립_댓글수정_성공.getMessageCode().equals(procedureVo.getRet())) {
            HashMap clipReplyList = new HashMap();
            P_ClipPlayVo pClipPlayVo = new P_ClipPlayVo(pClipReplyEditVo, request);
            clipReplyList.put("clipPlayInfo", clipPlayInfo(pClipPlayVo, request));
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글수정_성공, clipReplyList));
        }else if(ClipStatus.클립_댓글수정_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글수정_회원아님));
        }else if(ClipStatus.클립_댓글수정_클립없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글수정_클립없음));
        }else if(ClipStatus.클립_댓글수정_댓글번호없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글수정_댓글번호없음));
        }else if(ClipStatus.클립_댓글수정_작성자아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글수정_작성자아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글수정_실패));
        }
        return result;
    }
    ...
    public String clipReplyDelete(P_ClipReplyDeleteVo pClipReplyDeleteVo, HttpServletRequest request) {
        ...
        String result="";
        if(ClipStatus.클립_댓글삭제_성공.getMessageCode().equals(procedureVo.getRet())) {
            HashMap clipReplyList = new HashMap();
            P_ClipPlayVo pClipPlayVo = new P_ClipPlayVo(pClipReplyDeleteVo, request);
            clipReplyList.put("clipPlayInfo", clipPlayInfo(pClipPlayVo, request));
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글삭제_성공, clipReplyList));
        }else if(ClipStatus.클립_댓글삭제_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글삭제_회원아님));
        }else if(ClipStatus.클립_댓글삭제_클립없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글삭제_클립없음));
        }else if(ClipStatus.클립_댓글삭제_댓글번호없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글삭제_댓글번호없음));
        }else if(ClipStatus.클립_댓글삭제_작성자아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글삭제_작성자아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_댓글삭제_실패));
        }
        return result;
    }
    ...
    public String clipUploadList(P_ClipUploadListVo pClipUploadListVo) {
        ...
        if(DalbitUtil.isEmpty(clipUploadListVo)){
            ...
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_업로드목록_조회_없음, clipUploadList));
        }
        ...
        String result;
        if(Integer.parseInt(procedureOutputVo.getRet()) > 0) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_업로드목록_조회_성공, clipUploadList));
        }else if(ClipStatus.클립_업로드목록_조회_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_업로드목록_조회_회원아님));
        }else if(ClipStatus.클립_업로드목록_조회_스타회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_업로드목록_조회_스타회원아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_업로드목록_조회_실패));
        }
        return result;
    }
    ...
    public String clipListenList(P_ClipListenListVo pClipListenListVo) {
        ...
        if(DalbitUtil.isEmpty(clipListenListVo)){
            ...
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_청취내역_조회_없음, clipListenList));
        }
        ...
        String result;
        if(Integer.parseInt(procedureOutputVo.getRet()) > 0) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_청취내역_조회_성공, clipListenList));
        }else if(ClipStatus.클립_청취내역_조회_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_청취내역_조회_회원아님));
        }else if(ClipStatus.클립_청취내역_조회_스타회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_청취내역_조회_스타회원아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_청취내역_조회_실패));
        }
        return result;
    }
    ...
    public String clipPlayListEdit(P_ClipPlayListEditVo pClipPlayListEditVo) {
        ...
        String result="";
        if(ClipStatus.클립_재생목록편집_성공.getMessageCode().equals(procedureVo.getRet())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_재생목록편집_성공));
        }else if(ClipStatus.클립_재생목록편집_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_재생목록편집_회원아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_재생목록편집_실패));
        }
        return result;
    }
    ...
    public String clipMainPopList(P_ClipMainPopListVo pClipMainPopListVo, HttpServletRequest request) {
        ...
        if(DalbitUtil.isEmpty(clipMainPopListVo)){
            ...
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_인기리스트_조회_없음, clipMainPopList));
        }
        ...
        String result;
        if(Integer.parseInt(procedureOutputVo.getRet()) > 0) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_인기리스트_조회_성공, clipMainPopList));
        }else if(ClipStatus.클립_메인_인기리스트_조회_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_인기리스트_조회_회원아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_인기리스트_조회_실패));
        }
        return result;
    }
    ...
    public String clipMainLatestList(P_ClipMainLatestListVo pClipMainLatestListVo) {
        ...
        if(DalbitUtil.isEmpty(clipMainLatestListVo)){
            ...
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_최신리스트_조회_없음, clipMainLatestList));
        }
        ...
        String result;
        if(Integer.parseInt(procedureOutputVo.getRet()) > 0) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_최신리스트_조회_성공, clipMainLatestList));
        }else if(ClipStatus.클립_메인_인기리스트_조회_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_최신리스트_조회_회원아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_최신리스트_조회_실패));
        }
        return result;
    }
    ...
    public String clipMainSubjectTop3List(HttpServletRequest request) {
        ...
        if(DalbitUtil.isEmpty(codeVoList)){
            return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_주제별TOP3_조회_실패));
        }
        String result = "";
        ...
        for (int i = 0; i < codeVoList.size(); i++){
            ...
            if(ClipStatus.클립_메인_인기리스트_조회_회원아님.getMessageCode().equals(procedureVo.getRet())) {
                return gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_주제별TOP3_조회_회원아님, clipMainSubjectTop3List));
        ...
        if(clipMainSubjectTop3List.isEmpty()){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_주제별TOP3_조회_없음, clipMainSubjectTop3List));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립_메인_주제별TOP3_조회_성공, clipMainSubjectTop3List));
        }
    ...
    public String callClipDeclar(P_ClipDeclarVo pClipDeclarVo) {
        ...
        String result;
        if(procedureVo.getRet().equals(ClipStatus.클립신고_성공.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립신고_성공));
        }else if(procedureVo.getRet().equals(ClipStatus.클립신고_요청회원번호_정상아님.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립신고_요청회원번호_정상아님));
        }else if(procedureVo.getRet().equals(ClipStatus.클립신고_신고회원번호_정상아님.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립신고_신고회원번호_정상아님));
        }else if(procedureVo.getRet().equals(ClipStatus.클립신고_이미_신고상태.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립신고_이미_신고상태));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립신고_실패));
        }
        return result;
    }
    ...
    public HashMap clipShare(P_ClipPlayVo apiData, HttpServletRequest request) throws GlobalException{
        ...
        if(!DalbitUtil.isEmpty(clip)){
            ...
            if(!DalbitUtil.isEmpty(firebaseMap) && !DalbitUtil.isEmpty(firebaseMap.get("shortLink"))){
                ...
                result.put("status", ClipStatus.클립공유_성공);
                result.put("data", data);
            }else{
                result.put("status", ClipStatus.클립공유_동적링크실패);
            }
        }else{
            result.put("status", ClipStatus.클립공유_데이터없음);
        }
        return result;
    }
    ...
    public String callMyClip(P_MyClipVo pMyClipVo) {
        ...
        String result;
        if(procedureVo.getRet().equals(MypageStatus.내클립조회_성공.getMessageCode())) {
            HashMap resultMap = new Gson().fromJson(procedureVo.getExt(), HashMap.class);
            HashMap returnMap = new HashMap();
            returnMap.put("regCnt", DalbitUtil.getIntMap(resultMap, "regCnt"));
            returnMap.put("playCnt", DalbitUtil.getIntMap(resultMap, "playCnt"));
            ...
            result = gsonUtil.toJson(new JsonOutputVo(MypageStatus.내클립조회_성공, returnMap));
        }else if(procedureVo.getRet().equals(MypageStatus.내클립조회_요청회원번호_정상아님.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(MypageStatus.내클립조회_요청회원번호_정상아님));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(MypageStatus.내클립조회_실패));
        }
        return result;
    }
    ...
    public String callPlayConfirm(P_PlayConfirmVo pPlayConfirmVo) {
        ...
        String result;
        if(procedureVo.getRet().equals(ClipStatus.재생확인_성공.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.재생확인_성공));
        }else if(procedureVo.getRet().equals(ClipStatus.재생확인_요청회원번호_정상아님.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.재생확인_요청회원번호_정상아님));
        }else if(procedureVo.getRet().equals(ClipStatus.재생확인_클립번호없음.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.재생확인_클립번호없음));
        }else if(procedureVo.getRet().equals(ClipStatus.재생확인_번호없음.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.재생확인_번호없음));
        }else if(procedureVo.getRet().equals(ClipStatus.재생확인_클립번호_재생확인번호_불일치.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.재생확인_클립번호_재생확인번호_불일치));
        }else if(procedureVo.getRet().equals(ClipStatus.재생확인_이미확인.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.재생확인_이미확인));
        }else if(procedureVo.getRet().equals(ClipStatus.재생확인_60초미만.getMessageCode())) {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.재생확인_60초미만));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.재생확인_실패));
        }
        return result;
    }
    ...
    public String callClipRecommendList(P_ClipRecommendListInputVo pClipRecommendListInputVo) {
        ...
        if(Integer.parseInt(procedureVo.getRet()) > -1) {
            ...
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.달대리추천클립조회_성공, resultMap));
        } else if(procedureVo.getRet().equals(ClipStatus.달대리추천클립조회_회원아님.getMessageCode())){
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.달대리추천클립조회_회원아님));
        } else {
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.달대리추천클립조회_실패));
        }
        return result;
    }
    ...
    public String callClipRank(P_ClipRankListVo pClipRankListVo) {
        ...
        if(Integer.parseInt(procedureVo.getRet()) > -1) {
            ...
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립랭킹조회_성공, clipRankingInfo));
        }else{
            result = gsonUtil.toJson(new JsonOutputVo(ClipStatus.클립랭킹조회_실패));
        }
        return result;
    }
    ...
    public String callMyClipDetail(P_MyClipDetailListVo pMyClipDetailListVo) {
        ...
        if(Integer.parseInt(procedureVo.getRet()) > -1) {
            ...
            result = gsonUtil.toJson(new JsonOutputVo(MypageStatus.내클립현황상세조회_성공, myClipDetail));
        } else {
            result = gsonUtil.toJson(new JsonOutputVo(MypageStatus.내클립현황상세조회_실패));
        }
        return result;
    }
    ...
    public String callMyClipDetailEdit(P_MyClipDetailEditVo pMyClipDetailEditVo) {
        ...
        String result;
        if(MypageStatus.내클립현황_클립공개여부수정_성공.getMessageCode().equals(procedureVo.getRet())) {
            HashMap resultMap = new Gson().fromJson(procedureVo.getExt(), HashMap.class);
            HashMap returnMap = new HashMap();
            returnMap.put("openType", DalbitUtil.getIntMap(resultMap, "openType"));
            result = gsonUtil.toJson(new JsonOutputVo(MypageStatus.내클립현황_클립공개여부수정_성공, returnMap));
        } else if(MypageStatus.내클립현황_클립공개여부수정_회원아님.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(MypageStatus.내클립현황_클립공개여부수정_회원아님));
        } else if(MypageStatus.내클립현황_클립공개여부수정_클립없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(MypageStatus.내클립현황_클립공개여부수정_클립없음));
        } else if(MypageStatus.내클립현황_클립공개여부수정_수정권한없음.getMessageCode().equals(procedureVo.getRet())){
            result = gsonUtil.toJson(new JsonOutputVo(MypageStatus.내클립현황_클립공개여부수정_수정권한없음));
        } else {
            result = gsonUtil.toJson(new JsonOutputVo(MypageStatus.내클립현황_클립공개여부수정_실패));
        }
