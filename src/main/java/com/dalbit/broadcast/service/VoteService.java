...
import com.dalbit.common.code.VoteStatus;
...
public class VoteService {
    ...
    public String insVote(VoteRequestVo voteRequestVo, HttpServletRequest request) {
        if (StringUtils.isEmpty(voteRequestVo.getMemNo())
            ...
            return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_생성_파라미터, voteRequestVo));
        }
        int voteNo = 0;
        try {
            voteNo = voteDao.pRoomVoteIns(voteRequestVo);
            if (voteNo == 0) {
                return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_생성_에러, voteNo));
            }else if (voteNo == -1) {
                return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_생성_개수초과_에러, voteNo));
            }
        ...
        return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_생성, voteNo));
    }
    ...
    public String insMemVote(VoteRequestVo voteRequestVo, HttpServletRequest request) {
        if (StringUtils.isEmpty(voteRequestVo.getMemNo())
            ...
            return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_투표처리_파라미터, voteRequestVo));
        }
        int result = 0;
        ...
        try {
            ...
            if (result < 1) {
                return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_투표처리_에러, result));
            }
        ...
        return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_투표처리, result));
    }
    ...
    public String delVote(VoteRequestVo voteRequestVo, HttpServletRequest request) {
        if (StringUtils.isEmpty(voteRequestVo.getMemNo())
            ...
            return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_삭제_파라미터, voteRequestVo));
        }
        int result = 0;
        try {
            result = voteDao.pRoomVoteDel(voteRequestVo);
            if (result < 1) {
                return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_삭제_에러, result));
            }
        ...
        return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_삭제, result));
    }
    ...
    public String endVote(VoteRequestVo voteRequestVo, HttpServletRequest request) {
        if (StringUtils.isEmpty(voteRequestVo.getMemNo())
            ...
            return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_마감_파라미터, voteRequestVo));
        }
        int result = 0;
        try {
            ...
            if (result < 1) {
                if("a".equals(voteRequestVo.getEndSlct())){
                    return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_전체_마감_에러, result));
                }
                if("o".equals(voteRequestVo.getEndSlct())){
                    return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_단일_마감_에러, result));
                }
        ...
        if("o".equals(voteRequestVo.getEndSlct())){
            return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_단일_마감, result));
        }else {
            return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_전체_마감, result));
        }
    }
    ...
    public String getVoteList(VoteRequestVo voteRequestVo, HttpServletRequest request) {
        if (StringUtils.isEmpty(voteRequestVo.getMemNo())
            ...
            return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_리스트조회_파라미터, voteRequestVo));
        }
        ...
        try {
            ...
            if (pRoomVoteList == null || pRoomVoteList.isEmpty()) {
                return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_리스트조회_에러, null));
            }
        ...
        return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_리스트조회, returnMap));
    }
    ...
    public String getVoteSel(VoteRequestVo voteRequestVo, HttpServletRequest request) {
        if (StringUtils.isEmpty(voteRequestVo.getMemNo())
            ...
            return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_정보조회_파라미터, voteRequestVo));
        }
        ...
        try {
            ...
            if(info == null){
                return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_정보조회_에러, null));
            }
        } catch (Exception e) {
            log.error("VoteService getVoteSel Error => {}", e.getMessage());
        }
        return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_정보조회, info));
    }
    ...
    public String getVoteDetailList(VoteRequestVo voteRequestVo) {
        if (StringUtils.isEmpty(voteRequestVo.getMemNo())
            ...
            return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_항목조회_파라미터, voteRequestVo));
        }
        ...
        try {
            ...
            if(list == null){
                return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_항목조회_에러, null));
            }
            list = setVoteRank(list);
        } catch (Exception e) {
            log.error("VoteService getVoteDetailList Error => {}", e.getMessage());
        }
        return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_항목조회, list));
    }
    ...
    public String getVoteSelAndDetailList(VoteRequestVo voteRequestVo, HttpServletRequest request) {
        if (StringUtils.isEmpty(voteRequestVo.getMemNo())
            ...
            return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_항목과리스트_조회_파라미터, voteRequestVo));
        }
        ...
        try {
            ...
            if(detailList == null || detailList.isEmpty() || sel == null){
                return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_항목과리스트_조회_에러, null));
            }
        ...
        return gsonUtil.toJson(new JsonOutputVo(VoteStatus.투표_항목과리스트_조회, map));
    }
